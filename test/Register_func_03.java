        ...
        try {
            ...
            if (enteredValue.equals("Valid Company")) {
                ...
                test.fail("Failed to enter valid company name")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC26_validCompany_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid company name accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC27_invalidCompany_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Company empty accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC28_withoutCompany_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (entered) {
                ...
                test.fail("Failed to enter valid Address1")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC29_validAddress1_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid Address1 accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC30_invalidAddress1_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Empty Address1 accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC31_withoutAddress1_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (entered) {
                ...
                test.fail("Failed to enter valid Address2")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC32_validAddress2_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid Address2 accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC33_invalidAddress2_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Empty Address2 accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC34_withoutAddress2_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (selected) {
                ...
                test.fail("Country selection failed")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC35_countryDropdown_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (entered) {
                ...
                test.fail("Failed to enter valid state")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC36_validState_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid state accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC37_invalidState_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (entered) {
                ...
                test.fail("Failed to enter valid city")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC38_validCity_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid city accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC39_invalidCity_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Empty city accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC40_withoutCity_Fail"));
            }
        } catch (Exception e) {
