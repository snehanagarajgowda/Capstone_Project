        ...
        try {
            ...
            if (entered) {
                ...
                test.fail("Failed to enter zipcode in numbers")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC41_zipcodeNumbers_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid zipcode accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC42_zipcodeLetters_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (entered) {
                ...
                test.fail("Failed to enter valid zipcode")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC43_validZipcode_Fail"));
            }
        } catch (Exception e) {
    ...
    public void TC44_invalidZipcode() {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid zipcode accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC44_invalidZipcode_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (entered) {
                ...
                test.fail("Failed to enter mobile number in digits")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC45_mobileNumberDigits_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid mobile number accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC46_mobileNumberLetters_Fail"));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (entered) {
                ...
                test.fail("Failed to enter valid mobile number")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC47_validMobileNumber_Fail"));
            }
        } catch (Exception e) {
    ...
    public void TC48_invalidMobileNumber() {
        ...
        try {
            ...
            if (!entered) {
                ...
                test.fail("Invalid mobile number accepted")
                    .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "TC48_invalidMobileNumber_Fail"));
            }
        } catch (Exception e) {
