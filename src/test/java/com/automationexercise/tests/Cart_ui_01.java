...
import com.automationexercise.pages.TC_Cart_UI_01;
    ...
    public void TC01_verifyLogo() {
        ...
        try {
        	...
        	if(cartPage.isCartPageheadingDisplayed()) {
        		...
        		.addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC01_verifyCartLogo"));
        	}
        ...
        public void TC02_verifyProductsIcon() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC02_verifyCartPage"));
                }
                if (cartPage.isProductsIconVisible()) {
                    test.pass("Products icon is visible on Cart page");
                } else {
                    test.fail("Products icon is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC02_verifyProductsIcon"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC03_verifyCartIcon() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC03_verifyCartPage"));
                }
                if (cartPage.isCartIconVisible()) {
                    test.pass("Cart icon is visible on Cart page");
                } else {
                    test.fail("Cart icon is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC03_verifyCartIcon"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC04_verifySignupLoginIcon() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC04_verifyCartPage"));
                }
                if (cartPage.isSignupLoginIconVisible()) {
                    ...
                    test.fail("Signup/Login icon is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC04_verifySignupLoginIcon"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC05_verifyTestCasesIcon() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC05_verifyCartPage"));
                }
                if (cartPage.isTestCasesIconVisible()) {
                    ...
                    test.fail("Test Cases icon is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC05_verifyTestCasesIcon"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC06_verifyAPITestingIcon() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC06_verifyCartPage"));
                }
                if (cartPage.isAPITestingIconVisible()) {
                    ...
                    test.fail("API Testing icon is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC06_verifyAPITestingIcon"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC07_verifyVideoTutorialsIcon() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC07_verifyCartPage"));
                }
                if (cartPage.isVideoTutorialsIconVisible()) {
                    ...
                    test.fail("Video Tutorials icon is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC07_verifyVideoTutorialsIcon"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC08_verifyContactUsIcon() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC08_verifyCartPage"));
                }
                if (cartPage.isContactUsIconVisible()) {
                    ...
                    test.fail("Contact Us icon is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC08_verifyContactUsIcon"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC09_verifyEmptyCartMessage() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC09_verifyCartPage"));
                }
                if (cartPage.isEmptyCartMessageVisible()) {
                    ...
                    test.fail("Empty cart message is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC09_verifyEmptyCartMessage"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC10_verifyClickHereLink() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC10_verifyCartPage"));
                }
                if (cartPage.isClickHereLinkVisible()) {
                    ...
                    test.fail("Click here link is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC10_verifyClickHereLink"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC11_verifySubscriptionSection() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC11_verifyCartPage"));
                }
                if (cartPage.isSubscriptionSectionVisible()) {
                    ...
                    test.fail("Subscription section is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC11_verifySubscriptionSection"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC12_verifyEmailInput() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC12_verifyCartPage"));
                }
                if (cartPage.isEmailInputVisible()) {
                    ...
                    test.fail("Email input field is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC12_verifyEmailInput"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC13_verifySubmitButton() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC13_verifyCartPage"));
                }
                if (cartPage.isSubmitButtonVisible()) {
                    ...
                    test.fail("Subscription submit button is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC13_verifySubmitButton"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC14_verifyFooterSection() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC14_verifyCartPage"));
                }
                if (cartPage.isFooterSectionVisible()) {
                    ...
                    test.fail("Footer section is NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC14_verifyFooterSection"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC15_verifySocialMediaIcons() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC15_verifyCartPage"));
                }
                if (cartPage.areSocialMediaIconsVisible()) {
                    ...
                    test.fail("Social media icons are NOT visible")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC15_verifySocialMediaIcons"));
                }
            } catch (Exception e) {
                test.fail("Exception: " + e.getMessage());
            }
        ...
        public void TC16_verifyProductName() {
            ...
            try {
                ...
                if(cartPage.isCartPageheadingDisplayed()) {
                    ...
                    test.fail("Cart page not opened")
                        .addScreenCaptureFromPath(ScreenshotUtilities.capturescreenshot(driver, "TC16_verifyCartPage"));
                }
